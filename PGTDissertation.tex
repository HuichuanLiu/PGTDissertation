...
In this chapter, a series of techniques are introduced and compared to justify our workflow. The main components consist of data preprocess, feature extraction, machine learning and evaluation. In all stages, we list out candidate options we learned from literature and comment on the advantages and disadvantages in our project.     
